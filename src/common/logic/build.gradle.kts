...
kotlin {
    ...
    sourceSets {
        ...
        // "src" segment the flatten was meant to remove. These overrides point each
        // source set at <projectDir>/<sourceSetName>/kotlin instead.
        commonMain {
        ...
        iosMain {
            kotlin.setSrcDirs(listOf("iosMain/kotlin"))
            dependencies {
