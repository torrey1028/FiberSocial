 ...
 * decision — keep it in sync with [KeyValueTokenStorage][com.autom8ed.fibersocial.auth.KeyValueTokenStorage]
 * (encrypted token/session storage), the plain [KeyValueStore][com.autom8ed.fibersocial.storage.KeyValueStore]-backed
 * settings stores (theme, group order, notification settings), and
 * [NotificationState][com.autom8ed.fibersocial.notifications.NotificationState] (the local
